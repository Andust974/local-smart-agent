...
if __name__ == "__main__":
    host = "127.0.0.1"
    port = int(os.getenv("TASK_API_PORT", "8766"))
    # PYTHONUNBUFFERED уже в окружении, uvicorn сам логирует запросы
    uvicorn.run("bin.task_api:app", host=host, port=port, reload=False, access_log=True, factory=False)
